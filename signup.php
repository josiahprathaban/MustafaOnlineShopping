...
<form action="_signup.php" method="get">
    <a href="index.php"><img src="images/logo.png" width="300px"></br></br></a>
    <img src="images/profile.png" width="100px"></br>
    <label class="formHeading">CUSTOMER SIGNUP</label></br>
    <label class="formSubHeading">JOIN US | ITHU NALLAM</label></br>
